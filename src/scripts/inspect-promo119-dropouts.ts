/**
 * One-off introspection script: fetch the Promo 119 Dropouts tab and print
...
const SHEET_URL =
  'https://docs.google.com/spreadsheets/d/1uZQGunxqfmbcSwGf6WUKF-X19lEV49oCWQB0bWtHytQ/edit?usp=sharing'
