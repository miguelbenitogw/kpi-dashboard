/**
 * One-off introspection script: fetch the Promo 123 Dropouts tab and print
...
const SHEET_URL =
  'https://docs.google.com/spreadsheets/d/1EO9asPM2szskxdRS2Mr0shZ2rXQW_VjxX0SxqH4ZfHE/edit?usp=sharing'
