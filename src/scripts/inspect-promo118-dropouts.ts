/**
 * One-off introspection script: fetch the Promo 118 Dropouts tab and print
...
const SHEET_URL =
  'https://docs.google.com/spreadsheets/d/1tZRLdludT7joGhVLJ5INRGrV9brYhDmAC8B58uvQQNw/edit?usp=sharing'
