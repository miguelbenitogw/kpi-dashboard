/**
 * One-off introspection script: fetch the Promo 124 Dropouts tab and print
...
const SHEET_URL =
  'https://docs.google.com/spreadsheets/d/1bUGyx-QOMQLs88oDeuICrZ5_TQ5hMcFsiRMMkt4fBwk/edit?usp=sharing'
