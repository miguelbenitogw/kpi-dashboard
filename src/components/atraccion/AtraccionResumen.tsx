          ...
          <div style={{ fontSize: 11, color: P.muted, marginTop: 4, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
            ...
            {item.ratioExitoContactados != null && (() => {
              ...
              return (
                <>
                  <span>·</span>
                  <Tooltip text={`Candidatos que avanzaron positivamente (Hired + Approved by client + In Training) sobre el total de personas contactadas. Se excluyen del denominador los que nunca llegaron a hablar: Associated, Not Valid, No Answer, Rejected by client y New. Umbral: ${Math.round(threshold)}%`}>
